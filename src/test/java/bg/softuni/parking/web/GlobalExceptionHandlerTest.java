...
//        ModelAndView modelAndView = exceptionHandler.handleUsernameNotFoundException(exception, model);
//        assertEquals("error", modelAndView.getViewName());
//        assertEquals(exception, modelAndView.getModel().get("exception"));
//    }
//
...
//    @Test
//    void handleUsernameNotFoundException() {
//        bg.softuni.parking.exception.UsernameNotFoundException exception = new bg.softuni.parking.exception.UsernameNotFoundException("Username not found");
//        ModelAndView modelAndView = exceptionHandler.handleUsernameNotFoundException(exception, model);
//        assertEquals("error", modelAndView.getViewName());
//        assertEquals(exception, modelAndView.getModel().get("exception"));
//    }
